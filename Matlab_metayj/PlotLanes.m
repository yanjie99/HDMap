% Get the HD Map specification from RoadRunner by using the getMap function. 
% Notice that the function returns a structure and one of the fields contains information about the lanes.
hdMap = getMap(rrSim);
